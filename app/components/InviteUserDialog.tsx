            ...
            <CredenzaBody>
              <div className="grid gap-2">
                ...
                <p className="text-sm text-muted-foreground">
                  This link can only be used once and is tied to the email
                  address.
                </p>
              </div>
            </CredenzaBody>
            <CredenzaFooter>
              <div className="flex flex-col gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    if (invitationToken) {
                      window.location.href = `mailto:${email}?subject=Team Invitation&body=You've been invited to join a team. Click the following link to accept: ${encodeURIComponent(
                        invitationToken
                      )}`;
                    }
                  }}
